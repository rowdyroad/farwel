...
namespace soci {
    ...
    struct SOCI_EMPTY_DECL empty_standard_into_type_backend
        : details::standard_into_type_backend
    {
    ...
    struct SOCI_EMPTY_DECL empty_vector_into_type_backend
    ...
    struct SOCI_EMPTY_DECL empty_standard_use_type_backend
    ...
    struct SOCI_EMPTY_DECL empty_vector_use_type_backend
        : details::vector_use_type_backend
    {
    ...
    struct SOCI_EMPTY_DECL empty_statement_backend
        : details::statement_backend
    {
    ...
    struct SOCI_EMPTY_DECL empty_backend_factory
        : backend_factory
    {
